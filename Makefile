...
Makefile: SuperCoin-qt.pro  ../Qt/4.8.6/mkspecs/win32-g++-4.6/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec ..\Qt\4.8.6\mkspecs\win32-g++-4.6 -o Makefile SuperCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/SuperCoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/SuperCoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/SuperCoin/src/leveldb/libleveldb.a: FORCE
