...
const string strMessageMagic = "SuperCoin Signed Message:\n";
...
static const int64_t ifac1 = 127;		
static const int64_t ifac2 = 15;	
static const int64_t ifac3 = 3;		
...
int64_t GetProofOfWorkBonusRewardFactor(CBlockIndex* pindex)
{
	...
	int random = GenerateMTRandom(seed, 48000);

	// printf(">> cseed = %s, random = %d\n", cseed, random);

	if(random > 30000 && random < 30011)		// 1/4800
	{
		return ifac1;
	}
	else if(random > 10940 && random < 10991)	// 1/960
	{
		return ifac2;
	}
	else if(random > 20200 && random < 20601)	// 1/120
	{
		return ifac3;
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SuperCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SuperCoin is the first coin with Super-PoS-Block!";
        CTransaction txNew;
        txNew.nTime = 1400283987;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1400283987;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1512127;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xea8c47c1e142d545d1806d94f6d02c5f3c4af8e7c4c12bd6bc60ece0597fdef8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xdb, 0xfa, 0xfc, 0xfd };
